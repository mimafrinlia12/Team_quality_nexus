...
- Name: validation.spec.js >> TC_018 - Verify email field rejects invalid special characters
- Location: tests\validation.spec.js:50:5
...
Locator: getByText('Expected format: admin@example.com')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Expected format: admin@example.com')
    - waiting for "https://opensource-demo.orangehrmlive.com/web/index.php/recruitment/addCandidate/94" navigation to finish...
    - navigated to "https://opensource-demo.orangehrmlive.com/web/index.php/recruitment/addCandidate/94"
...
- separator
- text: Full Name*
- textbox "First Name" [disabled]: Xavier
- textbox "Middle Name" [disabled]: Boyd
- textbox "Last Name" [disabled]: Boyer
- text: Job Vacancy -- Select --  Email*
- textbox "Type here" [disabled]: julfiker#!$%^&*_+??$@ex.com
- text: Contact Number
